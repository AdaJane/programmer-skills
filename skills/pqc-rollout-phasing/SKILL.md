---
name: pqc-rollout-phasing
description: "Use when planning the deployment of a post-quantum change, when defining rollback thresholds, or when a rollout is being driven straight to 100% without dark launch or a tested rollback path."
---
