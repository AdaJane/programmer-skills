---
name: pqc-conformance-testing
description: "Use when testing a post-quantum implementation against known bug classes, when wiring a library into a conformance harness, or when deciding what NIST KATs and a clean handshake do and do not prove."
---
