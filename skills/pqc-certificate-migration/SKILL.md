---
name: pqc-certificate-migration
description: "Use when planning post-quantum certificate and PKI migration, when sizing handshake inflation from larger signatures, or when tempted to issue post-quantum certificate chains before the ecosystem supports them."
---
